...
const PAGE_ACCESS = {
  ...
  'behavioral-identity': [ROLE_SLUGS.ADMIN, ROLE_SLUGS.OPERATIONS_OFFICER, ROLE_SLUGS.LEGAL_SUPERVISOR],
  assistant: [ROLE_SLUGS.ADMIN, ROLE_SLUGS.OPERATIONS_OFFICER, ROLE_SLUGS.LEGAL_SUPERVISOR],
